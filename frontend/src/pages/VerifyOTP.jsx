...
//       // Handle response structure (checking for data wrapper if using Axios interceptor)
...
//       // ✅ Standardized Role-Based Navigation
//       const role = (data.userInfo?.role || data.role || "").toLowerCase();

//       if (role === "admin") {
//         navigate("/admin/dashboard");
//       } else if (role === "pharmacist" || role === "staff") {
//         navigate("/pharmacist/dashboard");
//       } else if (role === "customer" || role === "user") {
//         navigate("/customer-dashboard");
//       } else {
//         // Fallback to our central redirector
//         navigate("/dashboard");
//       }
//     } catch (err) {
//       setMessage(
...
//   infoText: { fontSize: "0.88rem", color: "#4b5563", marginBottom: 16 },
...
//     fontSize: "0.9rem",
//   },
//   message: { marginTop: 8, textAlign: "center", fontSize: "0.85rem" },
//   resendRow: { marginTop: 8, textAlign: "center" },
//   resendText: { fontSize: "0.82rem", color: "#6b7280" },
//   resendHighlight: { fontWeight: 600, color: "#111827" },
//   resendButton: {
//     border: "none",
//     background: "transparent",
//     color: "#2563eb",
