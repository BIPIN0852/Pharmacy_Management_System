...
//         <div className="container-fluid px-3 px-md-4 py-3 d-flex justify-content-between align-items-center gap-3">
//           <div
//             className="d-flex align-items-center gap-2 gap-md-3 cursor-pointer flex-shrink-0"
//             onClick={() => navigate("/")}
//           >
//             <div className="logo-icon shadow-sm d-flex align-items-center justify-content-center">
//               <Pill size={20} className="text-white d-md-none" />
//               <Pill size={24} className="text-white d-none d-md-block" />
//             </div>
//             <div className="d-none d-sm-block">
//               <div className="fw-black fs-5 fs-md-4 lh-1 theme-text logo-text">
//                 SmartPharmacy
//               </div>
//               <div
...
//           <div className="d-flex gap-2 gap-md-3 align-items-center flex-shrink-0">
//             {/* Language Toggle */}
//             <button
//               className="btn btn-sm btn-lang rounded-pill fw-bold d-flex align-items-center gap-1 px-2 px-md-3"
...
//             </button>
//             <button
//               className="btn btn-accent rounded-pill px-3 px-md-4 py-2 fw-bold shadow-lg hover-lift d-flex align-items-center gap-2"
//               onClick={() => navigate("/register")}
//             >
//               {t.getStarted}{" "}
//               <ArrowRight size={16} className="d-none d-sm-block" />
//             </button>
//           </div>
//         </div>
//       </header>
...
//       <section className="hero-section position-relative overflow-hidden pt-4 pt-md-5 pb-5">
//         <div className="hero-blob-1"></div>
//         <div className="hero-blob-2"></div>

//         <div className="container position-relative z-2 pt-2 pt-md-4 pb-5">
...
//               >
//                 <div
//                   className="d-inline-flex align-items-center gap-2 badge-glass text-accent px-3 py-2 rounded-pill mb-3 mb-md-4 fw-bold shadow-sm"
//                   style={{ fontSize: "0.85rem" }}
//                 >
//                   <Star size={14} className="fill-accent" /> {t.heroBadge}
//                 </div>
//                 <h1 className="hero-title fw-black theme-text mb-3 mb-md-4 font-playfair">
//                   {t.heroTitle1} <br className="d-none d-md-block" />
//                   <span className="text-gradient">{t.heroTitle2}</span>{" "}
//                   <br className="d-none d-md-block" />
//                   {t.heroTitle3}
//                 </h1>
//                 <p className="hero-desc theme-muted mb-4 mb-md-5 pe-lg-5 fw-medium">
//                   {t.heroDesc}
//                 </p>
//                 <div className="d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start">
//                   <button
//                     className="btn btn-accent btn-lg rounded-pill px-4 px-md-5 py-3 py-md-2 fw-bold shadow-lg hover-lift w-100 w-sm-auto"
//                     onClick={() => navigate("/register")}
//                   >
//                     {t.btnTransfer}
//                   </button>
//                   <button
//                     className="btn btn-glass btn-lg rounded-pill px-4 px-md-5 py-3 py-md-2 fw-bold hover-lift theme-text w-100 w-sm-auto"
//                     onClick={() => navigate("/login")}
//                   >
//                     {t.btnBrowse}
//                   </button>
...
//                 >
//                   <div className="icon-circle bg-success text-white flex-shrink-0">
//                     <ShieldCheck size={20} />
//                   </div>
//                   <div>
//                     <div className="fw-bolder theme-text small text-uppercase tracking-wider">
//                       {t.secureTitle || "100% Secure"}
//                     </div>
//                     <div className="small theme-muted fw-medium">
//                       {t.secureDesc || "Verified platform"}
//                     </div>
//                   </div>
//                 </motion.div>

//                 <div className="image-swapper rounded-4 rounded-md-5 shadow-2xl overflow-hidden border border-4 border-opacity-25 theme-border bg-dark w-100 h-100 position-absolute inset-0">
...
//       <div className="marquee-container py-2 py-md-3 shadow-sm border-top border-bottom">
...
//                 <div
//                   key={i}
//                   className="d-flex align-items-center gap-2 mx-4 mx-md-5"
//                 >
//                   <CheckCircle2
//                     size={18}
...
//                   />
//                   <span
//                     className="fw-bold fs-6 fs-md-5 theme-text"
...
//       <section className="stats-section py-4 py-md-5">
...
//                 <h2 className="stat-num fw-black text-gradient mb-1 mb-md-0">
//                   {stat.num}
//                 </h2>
//                 <span
//                   className="theme-muted fw-bold text-uppercase tracking-wider"
...
//         <div className="container py-3 py-md-5 z-2 position-relative">
//           <div className="row align-items-center g-4 g-md-5">
//             <div className="col-lg-5 order-lg-2 text-center text-lg-start">
//               <h2 className="section-title fw-black theme-text mb-3 mb-md-4 font-playfair">
//                 {t.showcaseTitle}
//               </h2>
//               <p className="fs-6 fs-md-5 theme-muted mb-4 mb-md-5 lh-base lh-md-lg">
//                 {t.showcaseDesc}
//               </p>
//               <button
//                 className="btn btn-accent rounded-pill px-4 px-md-5 py-3 fw-bold d-inline-flex align-items-center gap-2 gap-md-3 shadow-lg hover-lift w-100 w-sm-auto justify-content-center"
//                 onClick={() => navigate("/register")}
//               >
...
//             <div className="col-lg-7 order-lg-1 mt-5 mt-lg-0">
//               <div className="showcase-thumbnail rounded-4 rounded-md-5 overflow-hidden shadow-2xl border border-secondary border-opacity-25 position-relative bg-dark w-100">
//                 <AnimatePresence mode="wait">
//                   <motion.img
...
//           <div className="text-center mb-4 mb-md-5 pb-2 pb-md-3">
//             <h2 className="section-title fw-black theme-text mb-2 mb-md-3 font-playfair px-2">
//               {t.featuresTitle}
//             </h2>
//             <p className="fs-6 fs-md-5 theme-muted max-w-2xl mx-auto px-3">
//               {t.featuresDesc}
//             </p>
//           </div>
...
//                 <motion.div
//                   whileHover={{ y: -8 }}
//                   className="feature-card glass-card p-4 rounded-4 rounded-md-5 h-100 d-flex flex-column text-center align-items-center"
//                 >
//                   <div className="feature-icon bg-accent text-white rounded-circle d-flex align-items-center justify-content-center mb-3 mb-md-4 shadow flex-shrink-0">
//                     <f.icon size={24} className="d-md-none" />
//                     <f.icon size={28} className="d-none d-md-block" />
//                   </div>
//                   <h4 className="fw-bold theme-text mb-2 mb-md-3 fs-5 fs-md-4">
//                     {f.title}
//                   </h4>
//                   <p className="theme-muted small mb-0 lh-base lh-md-lg">
//                     {f.desc}
//                   </p>
//                 </motion.div>
//               </div>
...
//       <section className="faq-section py-4 py-md-5 position-relative">
//         <div className="container py-3 py-md-5" style={{ maxWidth: "800px" }}>
//           <div className="text-center mb-4 mb-md-5">
//             <div className="d-inline-flex bg-accent bg-opacity-10 text-accent p-2 p-md-3 rounded-circle mb-2 mb-md-3">
//               <MessageCircle size={28} className="d-md-none" />
//               <MessageCircle size={32} className="d-none d-md-block" />
//             </div>
//             <h2 className="section-title fw-black theme-text mb-3 mb-md-4 font-playfair px-2">
//               {t.faqTitle}
//             </h2>
//             <div
...
//             >
//               <Search
//                 className="position-absolute top-50 start-0 translate-middle-y ms-3 ms-md-4 theme-muted"
//                 size={18}
//               />
//               <input
//                 type="text"
//                 className="form-control form-control-md form-control-lg-lg ps-5 ps-md-5 rounded-pill border-0 bg-transparent theme-text py-2 py-md-3 fs-6"
...
//           <div className="faq-list d-flex flex-column gap-2 gap-md-3">
...
//                 <div
//                   key={index}
//                   className={`faq-item glass-card rounded-3 rounded-md-4 overflow-hidden transition-all ${activeFaq === index ? "active border-accent" : ""}`}
//                 >
//                   <button
//                     className="faq-btn w-100 border-0 p-3 p-md-4 d-flex justify-content-between align-items-center text-start bg-transparent theme-text fw-bold"
//                     onClick={() =>
//                       setActiveFaq(activeFaq === index ? null : index)
//                     }
//                   >
//                     <span className="fs-6 fs-md-5 pe-3">{item.q}</span>
//                     <div
...
//                       <ChevronDown
//                         size={18}
//                         className={`transition-all d-md-none ${activeFaq === index ? "rotate-180" : ""}`}
//                       />
//                       <ChevronDown
//                         size={20}
//                         className={`transition-all d-none d-md-block ${activeFaq === index ? "rotate-180" : ""}`}
//                       />
//                     </div>
//                   </button>
//                   <AnimatePresence>
...
//                       >
//                         <div className="pt-2 pt-md-3 border-top border-secondary border-opacity-10">
//                           <p className="theme-muted mb-0 fs-6 lh-base lh-md-lg">
//                             {item.a}
//                           </p>
//                         </div>
//                       </motion.div>
...
//         .hero-title { font-size: clamp(2.25rem, 5vw + 1rem, 4.5rem); line-height: 1.15; }
//         .hero-desc { font-size: clamp(1rem, 2vw + 0.5rem, 1.25rem); line-height: 1.6; }
//         .section-title { font-size: clamp(1.75rem, 4vw + 1rem, 3rem); line-height: 1.2; }
//         .stat-num { font-size: clamp(2.5rem, 5vw + 1rem, 4rem); }
...
//         .hero-image-wrapper { height: clamp(300px, 45vh, 550px); width: 100%; }
//         .showcase-thumbnail { height: clamp(250px, 40vh, 450px); width: 100%; }
...
//         .hero-blob-1 {
//           position: absolute; top: -10%; left: -10%; width: 50vw; height: 50vw; max-width: 500px; max-height: 500px;
//           background: var(--accent-color); opacity: 0.1; filter: blur(100px); border-radius: 50%; z-index: 1;
//         }
//         .hero-blob-2 {
//           position: absolute; bottom: -10%; right: -5%; width: 60vw; height: 60vw; max-width: 600px; max-height: 600px;
...
//         /* Logo */
//         .logo-icon { background: var(--accent-color); width: 36px; height: 36px; border-radius: 10px; }
...
//         /* Stats Responsive Grid Fixes */
//         .divider-row > div:not(:last-child) { border-right: 1px solid var(--border-color); }
//         @media (max-width: 767.98px) {
//           .divider-row > div { border-right: none !important; border-bottom: 1px solid var(--border-color); padding-bottom: 1.5rem; margin-bottom: 0.5rem; }
//           .divider-row > div:last-child { border-bottom: none; padding-bottom: 0; margin-bottom: 0; }
//           .floating-card { display: none !important; }
//         }

//         /* Features */
//         .feature-icon { width: 50px; height: 50px; }
//         @media (min-width: 768px) { .feature-icon { width: 60px; height: 60px; } }
...
//         @media (min-width: 768px) { .faq-icon { width: 32px; height: 32px; } }
...
const Home = () => {
  ...
  const [isNepali, setIsNepali] = useState(
    localStorage.getItem("appLang") === "ne",
  );
  ...
  const toggleLanguage = () => {
    ...
    // Trigger Google Translate globally if script is loaded
    if (select) {
      ...
      <header className="glass-nav sticky-top z-3 border-bottom border-opacity-10">
        <div className="container-fluid px-3 px-md-4 py-3 d-flex justify-content-between align-items-center gap-3">
          ...
          <div className="d-flex gap-2 gap-md-3 align-items-center flex-shrink-0">
            ...
            >
              <Globe size={14} /> {isNepali ? "EN" : "नेपाली"}
            </button>
            {/* Theme Toggle (Hooks into global useTheme context) */}
            <button
              className="btn btn-link theme-muted p-0 d-flex align-items-center hover-accent"
              onClick={toggleTheme}
              title="Toggle Theme"
