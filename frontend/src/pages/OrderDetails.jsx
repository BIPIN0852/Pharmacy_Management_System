...
//       <div className="d-flex justify-content-between align-items-center mb-4">
//         <h2 className="fw-bold mb-0">
//           {/* ✅ UPDATED: Show Real-World Order ID or fallback to Mongo ID */}
//           Order{" "}
//           {order.orderNumber
//             ? `#${order.orderNumber}`
...
//                 style={{ borderColor: "#D5D9D9" }}
//               >
//                 <Truck size={16} style={{ color: "#007185" }} />
//                 {status}
//               </Badge>
//             </div>
//           </Card.Body>
...
//         <Row className="g-4">
//           {/* Left Column: Items & Prescription */}
//           <Col lg={8}>
//             {/* Order Items */}
//             <Card
//               className="border-0 shadow-sm rounded-1 mb-4 bg-white"
...
//                       }
//                       text={
//                         order.prescriptionStatus === "Pending Verification"
//                           ? "dark"
//                           : "light"
//                       }
...
//                     className="d-inline-block border rounded-1 p-2 bg-light shadow-sm cursor-pointer hover-lift"
//                     style={{ borderColor: "#D5D9D9" }}
//                   >
//                     <Image
//                       src={
...
//                       <span
//                         className="small text-muted font-monospace text-truncate ms-3"
//                         title={order.paymentResult.id}
//                       >
//                         TXN: {order.paymentResult.id.substring(0, 10)}...
//                       </span>
//                     )}
//                   </div>
//                 </div>
...
//             </div>
//             <div className="d-flex gap-2">
//               {/* ✅ FIXED PAYMENT BADGE LOGIC HERE */}
//               <Badge
//                 bg={
//                   order.isPaid
//                     ? "success"
