...
const StripeCheckoutForm = ({ amount, orderId }) => {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <Button
        type="submit"
        className="w-100 py-3 py-md-2 shadow-sm border-0 rounded-1 fw-medium"
        style={{ backgroundColor: "#FFD814", color: "#0F1111" }}
        disabled={!stripe || processing}
      >
        {processing ? (
...
const Payment = () => {
  ...
  return (
    ...
    >
      <Container className="py-3 py-md-4 animate-fade-in">
        <div className="mb-3">
          <Button
            variant="link"
            className="text-decoration-none p-0 d-flex align-items-center hover-underline fw-medium"
        ...
        <Row className="g-3 g-md-4">
          <Col lg={8}>
            <Card
              className="border-0 shadow-sm rounded-2 h-100 bg-white"
              style={{ borderColor: "#D5D9D9" }}
            >
              <Card.Header className="bg-light border-bottom p-3 p-md-4">
                <h4 className="fw-bold mb-0 text-dark d-flex align-items-center gap-2 fs-5 fs-md-4">
                  Complete Your Payment
                </h4>
              </Card.Header>
              ...
              <Card.Body className="p-0 p-md-4">
                {message && (
                  <div className="p-3 pb-0 p-md-0">
                    <Alert
                      variant="danger"
                      className="py-2 small rounded-1 d-flex align-items-center gap-2 mb-md-3"
                    >
                ...
                {clientSecret ? (
                  <div
                    className="animate-fade-in border-0 border-md rounded-0 rounded-md-1 p-3 p-md-4"
                    style={{ borderColor: "#D5D9D9" }}
                  >
                    <h5 className="fw-bold text-dark d-flex align-items-center gap-2 border-bottom pb-3 mb-3 fs-6 fs-md-5">
                      <CreditCard
                        size={20}
                        style={{ color: "#007185" }}
                  ...
                  <div
                    className="border-0 border-md rounded-0 rounded-md-1 overflow-hidden"
                    style={{ borderColor: "#D5D9D9" }}
                  >
                    {/* Khalti Option */}
                    <div
                      className={`p-3 p-md-4 border-bottom cursor-pointer transition-all ${paymentMethod === "Khalti" ? "bg-light" : "bg-white hover-bg-light"}`}
                      onClick={() => setPaymentMethod("Khalti")}
                    >
                      <div className="d-flex align-items-center">
                        <Form.Check
                          ...
                          checked={paymentMethod === "Khalti"}
                          onChange={() => setPaymentMethod("Khalti")}
                          className="me-2 me-md-3 custom-radio flex-shrink-0"
                        />
                        <div className="d-flex justify-content-between align-items-center w-100 m-0">
                          <div className="d-flex flex-column pe-2">
                            <span className="fw-bold text-dark d-flex align-items-center fs-6 fs-md-5">
                              <Wallet
                                size={18}
                            ...
                            <small
                              className="text-muted ms-4 ps-1 lh-sm mt-1"
                    ...
                    {/* Stripe Option */}
                    <div
                      className={`p-3 p-md-4 border-bottom cursor-pointer transition-all ${paymentMethod === "Stripe" ? "bg-light" : "bg-white hover-bg-light"}`}
                      onClick={() => setPaymentMethod("Stripe")}
                    >
                      <div className="d-flex align-items-center">
                        <Form.Check
                    ...
                    {/* COD Option */}
                    <div
                      className={`p-3 p-md-4 cursor-pointer transition-all ${paymentMethod === "COD" ? "bg-light" : "bg-white hover-bg-light"}`}
                      onClick={() => setPaymentMethod("COD")}
                    >
                      <div className="d-flex align-items-center">
                        <Form.Check
          ...
          <Col lg={4}>
            <Card
              className="border-0 shadow-sm rounded-2 bg-white sticky-lg-top"
              style={{ top: "20px", borderColor: "#D5D9D9" }}
            >
              <Card.Body className="p-3 p-md-4">
                ...
                {!clientSecret && (
                  <Button
                    onClick={handlePaymentSubmit}
                    className="w-100 py-3 py-md-2 shadow-sm border-0 mb-3 rounded-1 hover-lift fw-medium d-flex justify-content-center align-items-center"
                    style={{
                      backgroundColor: "#FFD814",
                      color: "#0F1111",
                      fontSize: "0.95rem",
                ...
                <h5 className="fw-bold text-dark mb-3 fs-6 fs-md-5">
                  Payment Summary
                </h5>
                {createdOrderId && (
                  <div className="d-flex justify-content-between small mb-2 text-success fw-bold">
                ...
                {shippingAddress && (
                  <div className="bg-light p-3 mt-3 rounded-2 border border-light-subtle">
                    <div
                      className="fw-bold text-muted mb-1"
                      style={{ fontSize: "0.7rem", letterSpacing: "0.5px" }}
                    >
                ...
                <div
                  ...
                  style={{ color: "#B12704" }}
                >
                  <span className="fs-6 fs-md-5">Amount Due:</span>
                  <span className="fs-6 fs-md-5">
                    NPR {finalAmount.toFixed(2)}
                  </span>
                </div>
              </Card.Body>
            </Card>
