...
const CustomerLayout = () => {
  ...
  return (
    <div
      className={`customer-layout-wrapper d-flex transition-all ${collapsed ? "sidebar-collapsed" : "sidebar-open"}`}
      style={{
          ...
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex align-items-center gap-3 gap-md-4">
              ...
              <div
                ...
                title="View Cart"
              >
                <ShoppingCart size={20} className="d-sm-none" />
                <ShoppingCart size={24} className="d-none d-sm-block" />
                {cartCount > 0 && (
                  <span
              ...
              <Dropdown align="end">
                ...
                >
                  <MessageSquare size={20} className="d-sm-none" />
                  <MessageSquare size={24} className="d-none d-sm-block" />
                  {msgAlerts.length > 0 && (
                    <span
              ...
              <Dropdown align="end">
                <Dropdown.Toggle
                  variant="link"
                  className="d-flex align-items-center gap-2 gap-md-3 border-start ps-2 ps-md-4 text-decoration-none hide-caret hover-opacity transition-all"
                  style={{
