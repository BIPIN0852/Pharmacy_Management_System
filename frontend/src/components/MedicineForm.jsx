...
// import api from "../services/api"; // Added API import for the upload request
...
//     baseUnit: "Tablet",
//     units: [],
//     image: "", // Added image to initial state
//   });
...
//       baseUnit: form.baseUnit.trim() || "Tablet",
//       units: formattedUnits,
//       image: form.image || "/images/sample.jpg", // Include image in payload
//       batches: [
//         {
//           batchNumber: form.batchNumber.trim() || "BATCH-1",
//           expiryDate: form.expiryDate,
...
//               type="file"
//               accept="image/*"
//               className="form-control amazon-input shadow-none bg-light p-1"
