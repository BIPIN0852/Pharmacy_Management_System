...
function App() {
  // ✅ ADD THIS BLOCK: Safely load Google Translate AFTER React renders
  useEffect(() => {
    // Check if the script is already there so we don't load it twice
    if (!document.getElementById("google-translate-script")) {
      ...
      script.id = "google-translate-script"; // Tag it
      script.src =
