...
// // ✅ IMPORT the new Appointment Controller functions for the Doctor Dashboard
// const {
...
// // ===================================================================
// // Note: These must come before /:id so Express doesn't confuse "appointments" with a doctor ID
...
// // ✅ Added here to allow doctors to fetch their own profile
// router.get(
//   "/profile/me",
//   protect,
//   authorizeRoles("doctor"),
...
// // ✅ Added here to allow doctors to update their own settings & schedule
// router.put(
//   "/profile/me",
//   protect,
//   authorizeRoles("doctor"),
...
// ✅ ADDED THIS ROUTE HERE TO FIX THE 404 ERROR
router.delete(
  "/appointments/:id",
  protect,
  authorizeRoles("doctor"),
