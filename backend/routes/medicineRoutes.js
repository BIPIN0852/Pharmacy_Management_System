...
// // -------------------------------------------------------------------
// // ✅ NEW: EXPIRY ALERTS (For Pharmacist Dashboard)
// // -------------------------------------------------------------------
// router.get("/expired", protect, pharmacist, async (req, res) => {
//   try {
...
// Controllers (✅ ADDED FOR GEMINI AI)
const { generateMedicineSummary } = require("../controllers/aiController");
...
// -------------------------------------------------------------------
// EXPIRY ALERTS (For Pharmacist Dashboard)
// -------------------------------------------------------------------
router.get("/expired", protect, pharmacist, async (req, res) => {
  try {
    const today = new Date();
...
// -------------------------------------------------------------------
// ✅ PUBLIC: GENERATE AI MEDICINE INSIGHTS
// -------------------------------------------------------------------
router.post("/ai-summary", generateMedicineSummary);
