...
//     .populate("suppliedMedicines.medicine", "name manufacturer") // Optional: Populate medicine names
//     .sort({ createdAt: -1 });
//   res.json(suppliers);
// });
...
//   if (supplier) {
//     // ✅ FIXED: Soft Delete (Mark as Inactive instead of removing)
...
// const asyncHandler = require("express-async-handler");
// const Supplier = require("../models/Supplier");
// const Medicine = require("../models/Medicine"); // ✅ CRITICAL FIX: Required for populate() to work
...
//         model: "Medicine", // Explicitly state the model to prevent Schema errors
//       })
//       .sort({ createdAt: -1 });
...
//     // If it's a casting error due to old data format
//     if (
...
//         message:
//           "Database Schema Mismatch: Please delete old supplier records from MongoDB Compass. They are incompatible with the new Quantity feature.",
//       });
//     }
