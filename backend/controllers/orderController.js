...
//     shippingPrice,
//     totalPrice,
//     prescriptionImage, // ✅ NEW: Extract prescription image from request
//   } = req.body;
...
//   } else {
//     // ✅ NEW: Determine Prescription Status Logic
//     // If the frontend sent an image, we assume it needs verification
//     const needsPrescription = !!prescriptionImage;
//     const initialRxStatus = needsPrescription
//       ? "Pending Verification"
//       : "Not Required";

//     // If it needs verification, hold the order. Otherwise, start processing.
...
//   if (status === "Approved") {
//     // Move the order forward to processing
...
//   updatePrescriptionStatus, // ✅ Exported new function
// };
