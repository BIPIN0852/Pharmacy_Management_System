...
//     totalPrice,
//     prescriptionImage,
//     supportiveDocument, // ✅ ADDED: Catch the supportive document from frontend
//   } = req.body;
...
//   } else {
//     // ==========================================================
//     // ⏰ NEW: REFILL REMINDER MATH ENGINE
//     // ==========================================================
//     const updatedOrderItems = orderItems.map((item) => {
//       // 1. Calculate total individual units (e.g., 2 packs * 10 pills = 20 pills)
//       const totalUnits = item.qty * (item.buyingMultiplier || 1);

//       // 2. Guess daily dose from dosage guidelines (default to 1 per day)
//       let dailyDose = 1;
//       const dosageStr = (
//         item.dosageGuidelines ||
//         item.dosage ||
//         ""
//       ).toLowerCase();
//       if (dosageStr.includes("twice") || dosageStr.includes("2")) {
//         dailyDose = 2;
//       } else if (dosageStr.includes("thrice") || dosageStr.includes("3")) {
//         dailyDose = 3;
//       }

//       // 3. Calculate how many days the medicine will last
//       const daysSupply = Math.floor(totalUnits / dailyDose);

//       // 4. Set the exact date they will run out
...
//         refillReminderSent: false, // Flag for the Cron Job
//       };
//     });
//     // ==========================================================
...
//       orderItems: updatedOrderItems, // ✅ Replaced with the new array containing refill dates!
//       user: req.user._id,
//       shippingAddress,
//       paymentMethod,
//       itemsPrice,
...
//       supportiveDocument: needsPrescription ? supportiveDocument : null, // ✅ ADDED: Save to database
